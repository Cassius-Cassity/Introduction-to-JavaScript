...
if (computersChoice >= .66)
  computersChoice = 'rock';
else if (computersChoice < .66 && computersChoice >= .33)
  computersChoice = 'paper';
else if (computersChoice <= .33)
...
console.log(game('scissors', computersChoice));
